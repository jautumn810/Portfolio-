...
async function main() {
  ...
  const truckData = [
    ...
    // Volvo VNL 860
    {
      ...
      color: "Pearl White", imageUrl: "https://orion.soarr.com/photos/16383189/300x/2025-volvo-vnl+860.1.jpg",
    ...
    // Peterbilt 579
    {
      ...
      color: "Midnight Black", imageUrl: "https://m.media-amazon.com/images/I/61sKJG4pPgL.jpg",
    ...
    // Kenworth T680
    {
      ...
      color: "Glacier Blue", imageUrl: "https://d1zoyygth0y3um.cloudfront.net/efs/wp/domains/www.truckcountry.com/wp-content/uploads/2024/05/068PM00000BglVd-scaled.jpg",
    ...
    // Freightliner Cascadia
    {
      ...
      color: "Safety Orange", imageUrl: "https://images.worktrucksolutions.com/img/01314/inventory/GK8172/medium/2015-freightliner-cascadia-day-semi-truck-3.jpg",
    ...
    // International LT
    {
      ...
      color: "Forest Green", imageUrl: "https://international.imgix.net/-/media/project/tratongroup/international/international/common-media/lt-series/international-lt-all-grey-cabs-grey-background.png?h=1350&iar=0&w=2400&rev=7622e64eed0442598847df289e81b962&hash=F2EE91F1361709E02E06DB70557F1B37",
    ...
    // Mack Anthem
    {
      ...
      color: "Steel Grey", imageUrl: "https://orion.soarr.com/photos/16383121/300x/2021-mack-anthem.1.jpg",
    ...
    // Western Star 5700
    {
      ...
      color: "Chrome Silver", imageUrl: "https://www.fleetequipmentmag.com/wp-content/uploads/2014/09/Western-Star-5700XE-7.jpg",
    ...
    // Peterbilt 389 (classic)
    {
      ...
      color: "Burgundy", imageUrl: "https://static.overfuel.com/dealers/forge-truck-centers/image/Forge-Truck-Centers-Why_the_Peterbilt_389_is_One_of_the_Best_Truck_Models_Ever_Made.webp",
